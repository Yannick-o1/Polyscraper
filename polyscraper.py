...
PROBABILITY_DELTA_THRESHOLD = 10.0  # Deprecated in favor of dynamic sizing
...
def collect_data_once():
    ...
    try:
        ...
        if best_bid and best_ask:
            ...
            print(f"\n  [LOG]   DB record created for {asset_name}={btc_price_str}, P(Up)={prediction_str}, Bid={best_bid_price:.2f}, Ask={best_ask_price:.2f}")
